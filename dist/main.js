...
`),J=T,N=q,W=a.ZP.div((()=>a.iv``)),M=a.ZP.div((({theme:e})=>a.iv`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
  ...
  `)),F=a.ZP.p((e=>a.iv`
    ...
    animation: ${J} 0.5s ease-out;
  `)),D=e=>{const{show:t,type:i,title:r,description:s}=e;return(0,o.jsxs)(W,{children:[(0,o.jsx)(E,Object.assign({check:t&&"icon"===i},{children:(0,o.jsx)(Z,{children:(0,o.jsx)(C,{type:"spinner",size:12})})})),(0,o.jsx)(E,Object.assign({check:t&&"fullScreen"===i},{children:(0,o.jsxs)(M,{children:[(0,o.jsx)(Z,{children:(0,o.jsx)(C,{type:"spinner",size:12})}),(0,o.jsx)(G,{children:r}),(0,o.jsx)(F,{children:s})]})}))]})},U=a.ZP.label((({theme:e})=>a.iv`
    display: flex;
    align-items: center;
    padding: 0 ${e.size(2)};
