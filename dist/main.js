(()=>{"use strict";var e,t,i,r={936:(e,t,i)=>{var r=i(893),s=i(745),n=i(655),o=i(250),a=i(294);const c=(0,a.createContext)(null),l=e=>{const[t,i]=(0,a.useState)("/home"),[s,n]=(0,a.useState)(""),o={pathname:t,hash:"",search:"",lang:s,setPath:i,setLang:n},l=(0,a.useMemo)((()=>o),[JSON.stringify(o)]);return(0,r.jsx)(c.Provider,Object.assign({value:l},{children:e.children}))};var d=i(133);i.p;const h=(0,d.vJ)((({theme:e})=>d.iv`
    * {
      margin: 0;
      padding: 0;
      outline: 0;
  ...
  `)),z=e=>(0,r.jsx)(S,{children:(0,r.jsx)(k,{children:(0,r.jsx)(P,Object.assign({id:"doc-content"},{children:e.children}))})});const $=()=>{return e=void 0,t=void 0,r=function*(){const e=document.getElementById("doc-content"),t=document.createElement("iframe");document.body.appendChild(t);const i=t.contentDocument;i.head.innerHTML=document.head.innerHTML,i.body.innerHTML=e.innerHTML,t.style.position="absolute",t.style.left="100%",t.style.top="0",yield new Promise((e=>setTimeout(e,1e3))),t.contentWindow.print()},new((i=void 0)||(i=Promise))((function(s,n){function o(e){try{c(r.next(e))}catch(e){n(e)}}function a(e){try{c(r.throw(e))}catch(e){n(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof i?t:new i((function(e){e(t)}))).then(o,a)}c((r=r.apply(e,t||[])).next())}));var e,t,i,r};var O=i(279);const A={download:(0,r.jsx)(O.HA8,{}),selector:(0,r.jsx)(O.ZaQ,{})},I=d.ZP.span((({theme:e,size:t})=>d.iv`
    display: inline-flex;
    font-size: ${e.size(t||7)};
    cursor: pointer;
  `)),C=e=>{const{type:t,size:i,style:s,onPress:n}=e;return(0,r.jsx)(I,Object.assign({className:"icon",size:i,style:s,onClick:n},{children:A[t]}))},E=d.ZP.div((({theme:e})=>d.iv`
    width: 100%;
    display: flex;
  ...
  `)),T=d.ZP.select((({theme:e})=>d.iv`
    background-color: ${e.colors.bg2};
  `)),J=d.ZP.button((({theme:e})=>d.iv`
    background-color: ${e.colors.bg2};
  `)),R=()=>{const e=location.href.split("?");return new URLSearchParams(e[1]).get("lang")||""},q=R(),N=()=>(0,r.jsxs)(E,{children:[(0,r.jsx)(T,{children:(0,r.jsx)("option",{children:"Template 1"})}),(0,r.jsxs)(T,Object.assign({defaultValue:q,onChange:e=>(e=>{const[t,i]=location.href.split("?"),r=new URLSearchParams(i);r.set("lang",e),location.href=`${t}?${r.toString()}`})(e.target.value)},{children:[(0,r.jsx)("option",Object.assign({value:"en"},{children:"English"})),(0,r.jsx)("option",Object.assign({value:"pt"},{children:"Português"}))]})),(0,r.jsxs)(J,Object.assign({onClick:$},{children:[(0,r.jsx)(C,{type:"download"}),"Save as PDF"]}))]}),M=d.ZP.div((({theme:e})=>d.iv`
    width: 100%;
    height: 100%;
    padding: ${e.size(4)};
    background-color: ${e.colors.bg4};
  `)),W=e=>(0,r.jsx)(M,{children:e.children}),Z=JSON.parse('{"header_address":"Address","header_city":"City","header_phone":"Phone","cv_resume":"A small guy from a small town with big dreams who loves programming any kind of ideas and like to spent hours trying to improve his own code, like to always code his own solution to the problem but keeping everthing as simple as possible, like to learn new ways to coding and build applications and of course like games.","experience_title":"Experience","experience_westpoint_text":"UK software company that provides software development services to third-party companies.","experience_collums_text":"Online platform used to manage Aesthetic clinics with more than 11 franchises as client, built with ReactJS, NodeJS, Mongodb and Docker.","experience_vouchio_text":"Mobile Application used to handles vehicles (open/close doors, start/stop engine, etc), built with ClojureScript, React Native, Blockchain API, Android/IOS APIs.","experience_talentId_text":"Online platform that uses the powers of GPT chat to evaluate candidates\' CVs and assign them a score. built with NextJS with MatineUI, OpenAI API and AWS services.","experience_vintage_text":"Dashboard for inventory management and barrel sales, synchronized with Google spreadsheets, built with ViteJS with MantineUI, Google APIs and AWS services.","experience_quarx_text":"Browser extension that provides real-time guides to help users perform complex tasks across many Websites (AWS, Google cloud, etc), built with React, Chrome APIs and AWS services.","experience_website_text":"Company website built with NextJS and Styled Components.","experience_socialpower_text":" Web application with geolocation to map streets points that need attention from the city hall, built using nodeJS and AngularJS.","education_title":"Education","extraworks_title":"Extra Works","extraworks_personalcv_text":"This document available in multiple languages. built with ReactJS.","extraworks_consoleui_text":"Application that provide console interface like PS5/Xbox for PCs. built with React and Electron.","extraworks_easyencrypt_text":"Web and Mobile application to encrypt plan text. built with React, React Native and CryptoJS.","extraworks_taskmanage_text":"Todo application with calendar and notes. built with React.","extraworks_translationpwa_text":"Translation website with multiple language support. built with React and GoogleAPIs."}'),F=JSON.parse('{"header_address":"Endereço","header_city":"Cidade","header_phone":"Telefone","cv_resume":"Um cara pequeno de uma cidade pequena com grandes sonhos que adora programar qualquer tipo de ideia e gosta de passar horas tentando melhorar seu próprio código, gosta de sempre codificar sua própria solução para o problema mas mantendo tudo o mais simples possível, gosta de aprender ","experience_title":"Experiência","experience_westpoint_text":"Empresa de software do Reino Unido que fornece serviços de desenvolvimento de software para empresas terceirizadas.","experience_collums_text":"Plataforma online utilizada para gerenciamento de clínicas de Estética com mais de 11 franquias como cliente, construída com ReactJS, NodeJS, Mongodb e Docker.","experience_vouchio_text":"Aplicativo móvel usado para lidar com veículos (abrir/fechar portas, ligar/desligar motor, etc), construído com ClojureScript, React Native, API Blockchain, APIs Android/IOS.","experience_talentId_text":"Plataforma online que utiliza os poderes do chat GPT para avaliar os currículos dos candidatos e atribuir-lhes uma pontuação. ","experience_vintage_text":"Dashboard para gestão de estoque e vendas de barris, sincronizado com planilhas Google, construído em ViteJS com MantineUI, APIs Google e serviços AWS.","experience_quarx_text":"Extensão de navegador que fornece guias em tempo real para ajudar os usuários a realizar tarefas complexas em muitos sites (AWS, Google Cloud, etc.), desenvolvidos com React, APIs do Chrome e serviços AWS.","experience_website_text":"Site da empresa construído com NextJS e Styled Components.","experience_socialpower_text":" Aplicação web com geolocalização para mapear pontos de ruas que necessitam de atenção da prefeitura, construída em nodeJS e AngularJS.","education_title":"Educação","extraworks_title":"Trabalhos extras","extraworks_personalcv_text":"Este documento está disponível em vários idiomas. ","extraworks_consoleui_text":"Aplicativo que fornece interface de console como PS5/Xbox para PCs. ","extraworks_easyencrypt_text":"Aplicativo Web e Mobile para criptografar o texto do plano. ","extraworks_taskmanage_text":"Aplicativo Todo com calendário e notas. ","extraworks_translationpwa_text":"Site de tradução com suporte a vários idiomas. "}'),G=JSON.parse('{"header_address":"Dirección ÓN","header_city":"Ciudad","header_phone":"Teléfono","cv_resume":"Un chico pequeño de un pueblo pequeño con grandes sueños a quien le encanta programar cualquier tipo de idea y le gusta pasar horas tratando de mejorar su propio código, le gusta codificar siempre su propia solución al problema pero manteniendo todo lo más simple posible, le gusta aprender. ","experience_title":"Experiencia","experience_westpoint_text":"Empresa de software del Reino Unido que proporciona servicios de desarrollo de software a empresas de terceros.","experience_collums_text":"Plataforma online utilizada para gestionar clínicas de Estética con más de 11 franquicias como cliente, construida con ReactJS, NodeJS, Mongodb y Docker.","experience_vouchio_text":"Aplicación móvil utilizada para manejar vehículos (abrir/cerrar puertas, arrancar/parar motor, etc.), construida con ClojureScript, React Native, API Blockchain, API de Android/IOS.","experience_talentId_text":"Plataforma online que utiliza las potencias del chat GPT para evaluar los CV de los candidatos y asignarles una puntuación. ","experience_vintage_text":"Dashboard para gestión de inventario y venta de barriles, sincronizado con hojas de cálculo de Google, construido con ViteJS con MantineUI, API de Google y servicios de AWS.","experience_quarx_text":"Extensión del navegador que proporciona guías en tiempo real para ayudar a los usuarios a realizar tareas complejas en muchos sitios web (AWS, nube de Google, etc.), creada con React, API de Chrome y servicios de AWS.","experience_website_text":"Sitio web de la empresa creado con NextJS y Styled Components.","experience_socialpower_text":" Aplicación web con geolocalización para mapear puntos de calles que necesitan atención del ayuntamiento, construida usando nodeJS y AngularJS.","education_title":"Educación","extraworks_title":"Trabajos adicionales","extraworks_personalcv_text":"Este documento está disponible en varios idiomas. ","extraworks_consoleui_text":"Aplicación que proporciona una interfaz de consola como PS5/Xbox para PC. ","extraworks_easyencrypt_text":"Aplicación web y móvil para cifrar texto del plan. ","extraworks_taskmanage_text":"Aplicación Todo con calendario y notas. ","extraworks_translationpwa_text":"Sitio web de traducción con soporte para múltiples idiomas. "}'),L=R(),D=Z,B=F,U=G,V=e=>{const{path:t}=e;return"en"===L?(0,r.jsx)(r.Fragment,{children:D[t]||"NO TEXT"}):"es"===L?(0,r.jsx)(r.Fragment,{children:U[t]||"NO TEXT"}):"pt"===L?(0,r.jsx)(r.Fragment,{children:B[t]||"NO TEXT"}):(0,r.jsx)(r.Fragment,{children:"NO TEXT"})},Q=d.ZP.div((()=>d.iv``)),X=d.ZP.div((({theme:e})=>d.iv`
    width: 100%;
