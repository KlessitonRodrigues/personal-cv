...
export const themeColors: Record<IThemeColors, any> = {
  ...
  magenta: { main: material.red['700'], mainBg: material.red['900'] },
  red: { main: material.red['700'], mainBg: material.red['900'] },
...
export const getTheme = (dark: boolean, color: IThemeColors) => {
  const theme: IThemeProps = {
    ...
    shadow: {
      lg: '1px 1px 8px 0 #0006',
      md: '1px 1px 6px 0 #0004',
      sm: '1px 1px 4px 0 #0002',
    },
    border: {
